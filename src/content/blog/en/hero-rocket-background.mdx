...
description: "The homepage hero in Astro Rocket shows a large faint rocket icon in the background on desktop in dark mode. It follows the active colour theme automatically, sits behind all content, and can be toggled off with a single prop."
